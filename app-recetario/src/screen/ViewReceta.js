...
export default function ViewReceta({navigation}) {
   ...
   ///console.log(route.params.item)
    ...
    return (
        <View style={styles.container}>  
            <RecetaHeader  id={route.params.item.id} style={styles.header} title={route.params.item.name} imagen={route.params.item.image } />
